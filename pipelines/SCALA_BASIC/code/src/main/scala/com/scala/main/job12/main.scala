...
import com.scala.main.job12.graph.reformatted_columns_1
...
import com.scala.main.job12.graph.reformatted_columns_1.config.{
  Context => reformatted_columns_1_Context
}
...
object Main {
  ...
  def graph(context: Context): Unit = {
    ...
    val df_reformatted_columns_1 = reformatted_columns_1.apply(
      reformatted_columns_1_Context(context.spark,
                                    context.config.reformatted_columns_1
      ),
