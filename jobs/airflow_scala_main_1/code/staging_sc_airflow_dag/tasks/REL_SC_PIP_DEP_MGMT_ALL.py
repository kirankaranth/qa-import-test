    ...
    return DatabricksSubmitRunOperator(  # noqa
        ...
        json = {
          ...
          "libraries": [{"maven" : {"coordinates" : "io.prophecy:prophecy-libs_2.12:3.4.0-7.1.46"}},                          {"pypi" : {"package" : "prophecy-libs==1.7.3"}},                          {
                         ...
                         },                          {"maven" : {"coordinates" : "mysql:mysql-connector-java:8.0.29", "exclusions" : []}},                          {"maven" : {"coordinates" : "org.typelevel:cats-core_2.12:2.6.1", "exclusions" : []}},                          {"maven" : {"coordinates" : "org.apache.spark:spark-mllib_2.12:3.3.0", "exclusions" : []}}]
        },
